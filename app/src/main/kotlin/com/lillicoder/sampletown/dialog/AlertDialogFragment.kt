...
class AlertDialogFragment : DialogFragment() {
    ...
    private fun createAlertDialogBuilder(context: Context, builder: Builder?): AlertDialog.Builder {
        ...
        if (builder != null) {
            ...
            alertDialogBuilder
                .setPositiveButton(builder.positiveButton()) { _, _ -> listener?.onPositiveButtonClick(tag) }
                .setNegativeButton(builder.negativeButton()) { _, _ -> listener?.onNegativeButtonClick(tag) }
                .setNeutralButton(builder.neutralButton()) { _, _ -> listener?.onNeutralButtonClick(tag) }
        }
    ...
    class Builder(
        ...
        /**
         * Sets whether the dialog is cancelable on touch events outside its view bounds (defaults to true).
         ...
         * @return This builder instance.
         */
        fun icon(@DrawableRes id: Int) = apply { this.iconId = id }
         ...
         * @return This builder instance.
         */
        fun linkable(isLinkable: Boolean) = apply { this.isLinkable = isLinkable }
         ...
         * @return This builder instance.
         */
        fun message(context: Context, @StringRes id: Int) = apply { this.message = context.getText(id) }
        ...
        /**
         * Sets the text for the positive button of the dialog generated by this builder using the given resource ID.
         * @param context [Context] to get text with.
         * @param id Resource ID of the text to set.
         * @return This builder instance.
         */
        fun positiveButton(context: Context, @StringRes id: Int) = apply { this.positiveButtonText = context.getText(id) }
        ...
        /**
         * Sets the text for the negative button of the dialog generated by this builder using the given resource ID.
         * @param context [Context] to get text with.
         * @param id Resource ID of the text to set.
         * @return This builder instance.
         */
        fun negativeButton(context: Context, @StringRes id: Int) = apply { this.negativeButtonText = context.getText(id) }
        ...
        /**
         * Sets the text for the neutral button of the dialog generated by this builder using the given resource ID.
         * @param context [Context] to get text with.
         * @param id Resource ID of the text to set.
         * @return This builder instance.
         */
        fun neutralButton(context: Context, @StringRes id: Int) = apply { this.neutralButtonText = context.getText(id) }
         ...
         * @return This builder instance.
         */
        fun title(context: Context, @StringRes id: Int) = apply { this.title = context.getText(id) }
        ...
        fun view(@LayoutRes id: Int) = apply { this.layoutId = id }
    }
}
